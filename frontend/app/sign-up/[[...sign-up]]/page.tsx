    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f0f4ff] to-[#f5f0ff] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <h1 className="font-poppins font-extrabold text-2xl text-charcoal">Create Account</h1>
          <p className="text-mid-gray font-inter text-sm mt-1">Join thousands of patients on Hussain Healthcare</p>
        </div>
        <SignUp />
      </div>
    </div>
